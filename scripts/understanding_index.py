...
CATALOG = [
    ...
    D("2026-08-06-explanation-cross-language-recall-bottleneck.html",
      ...
      related=["2026-08-14-explanation-missing-and-same-as.html",
               ...
               "2026-08-18-explanation-search-text-embedding.html"]),
    D("2026-08-18-explanation-search-text-embedding.html",
      "검색 문자열은 원문이 아니다",
      "재조립된 search_text 가 숫자를 잃는 자리, 그리고 그것을 재다 뒤집힌 세 가지.",
      "concept", "incident",
...
SYMPTOMS = [
    ...
    ("맞는 후보인데 top_k 밖으로 밀린다",
     "임베딩에 들어가는 문자열은 원문이 아니라 재조립본이라, 숫자가 통째로 빠질 수 있다.",
     ["2026-08-18-explanation-search-text-embedding.html",
      "2026-08-06-explanation-cross-language-recall-bottleneck.html"]),
