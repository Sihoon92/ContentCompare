#!/usr/bin/env python3
"""엑셀/워드 파일을 physical_raw.json 으로 덤프해 눈으로 확인하는 도구.
...
from contentcompare.raw import extract_raw, raw_to_json  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="문서 → physical_raw.json 덤프")
